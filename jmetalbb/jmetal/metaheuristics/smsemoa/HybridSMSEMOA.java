 ...
 */
public class HybridSMSEMOA extends Algorithm {

    /**
     * stores the problem to solve
     */
    private final MetricsUtil utils_;
    private final Hypervolume hv_;
     ...
     */
    public HybridSMSEMOA(Problem problem) {
        super(problem);
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (evaluations < maxEvaluations) {
            ...
            //    population.printObjectivesToFile("smsemoa.FUN." + evaluations + "." + run);
            //}
        } // while
