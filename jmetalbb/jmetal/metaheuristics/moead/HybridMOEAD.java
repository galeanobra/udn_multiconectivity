...
public class HybridMOEAD extends Algorithm {
     ...
     */
    public HybridMOEAD(Problem problem) {
        super(problem);
...
*/
        ...
        do {
            ...
            for (int i = 0; i < populationSize_; i++) {
                ...
                // Apply DE crossover
               //Solution [] childs = (Solution[]) crossover_.execute(new Object[]{population_.get(n), parents});
