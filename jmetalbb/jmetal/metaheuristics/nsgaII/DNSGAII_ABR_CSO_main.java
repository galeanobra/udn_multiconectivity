 ...
 */
public class DNSGAII_ABR_CSO_main {
    ...
    public static void main(String[] args) throws
        ...
        DynamicCSO problem; // The problem to solve
        DNSGAII_ABR algorithm; // The algorithm to use
        ...
        double abrRate = Double.parseDouble(args[3]);
        int abrLength = Integer.parseInt(args[4]);
        ...
        // problem = new StaticCSO("main.conf", run, epochs);

        algorithm = new DNSGAII_ABR(problem);
        ...
        algorithm.setInputParameter("abrRate", abrRate);
        algorithm.setInputParameter("abrLength", abrLength);
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DNSGAII_ABR.VAR" +
                    ".r" + restart +
                    ".rR" + abrRate +
                    ".rL" + abrLength +
                    ".e" + i +
                    "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DNSGAII_ABR.FUN" +
                    ".r" + restart +
                    ".rR" + abrRate +
                    ".rL" + abrLength +
                    ".e" + i +
