 ...
 */
public class DNSGAII_A_CSO_main {
    ...
    public static void main(String[] args) throws
        ...
        DNSGAII_A algorithm; // The algorithm to use
        ...
        algorithm = new DNSGAII_A(problem);
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DNSGAII_A.VAR.r" + restart + ".e" + i + "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DNSGAII_A.FUN.r" + restart + ".e" + i + "." + run);
        }
