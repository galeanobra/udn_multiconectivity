 ...
 */
public class DNSGAII_NRC_CSO_main {
    ...
    public static void main(String[] args) throws
        ...
        DNSGAII_NRC algorithm; // The algorithm to use
        ...
        algorithm = new DNSGAII_NRC(problem);
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DNSGAII_NRC.VAR.e" + i + "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DNSGAII_NRC.FUN.e" + i + "." + run);
        }
