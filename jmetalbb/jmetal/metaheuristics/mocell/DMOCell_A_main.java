...
public class DMOCell_A_main {
    ...
    public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DMOCell_A.VAR.r" + restart + ".e" + i + "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DMOCell_A.FUN.r" + restart + ".e" + i + "." + run);
        }
