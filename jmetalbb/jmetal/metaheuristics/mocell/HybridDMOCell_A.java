...
public class HybridDMOCell_A extends Algorithm {
     ...
     */
    public HybridDMOCell_A(Problem problem) {
        super(problem);
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        for (int epoch = 0; epoch <= ((DynamicCSO) problem_).getNumberOfEpochs(); epoch++) {
            ...
            for (int i = 0; i < restartSolutions; i++) {
                ...
                evaluations++;
                newSolution.setLocation(permutation[i]);
                currentPopulation.replace(permutation[i], newSolution);
            } //for
