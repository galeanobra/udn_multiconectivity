...
public class DMOCell_B_main {
    ...
    public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
        ...
        DMOCell_B algorithm;         // The algorithm to use
        ...
        algorithm = new DMOCell_B(problem);
        ...
        parameters = new HashMap();
        parameters.put("probability", 1.0 / ((CSO) problem).getTotalNumberOfActivableCells());
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DMOCell_B.VAR.r" + restart + ".e" + i + "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DMOCell_B.FUN.r" + restart + ".e" + i + "." + run);
        }
