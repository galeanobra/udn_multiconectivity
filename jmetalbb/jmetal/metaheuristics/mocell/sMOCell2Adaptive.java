 ...
 */
public class sMOCell2Adaptive extends Algorithm {
     ...
     */
    public sMOCell2Adaptive(Problem problem) {
        super(problem);
    } //sMOCell2
...
/*     
      ...
      for (int i = 0; i < currentSolutionSet.size(); i++) {
        if ((int) currentSolutionSet.get(i).getFitness() != -1) {
          contributionCounter_[(int) currentSolutionSet.get(i).getFitness()] += 1;
        }
        currentSolutionSet.get(i).setFitness(-1);
      }
*/
            ...
            for (int i = 0; i < archive.size(); i++) {
                if ((int) archive.get(i).getFitness() != -1) {
                    contributionCounter_[(int) archive.get(i).getFitness()] += 1;
                }
