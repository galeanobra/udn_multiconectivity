...
public class DMOCell_ABR_main {
    ...
    public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
        ...
        DMOCell_A algorithm;         // The algorithm to use
        ...
        for (int i = 0; i <= epochs; i++) {
            frontsAtEpoch.get(i).printVariablesToFile("DMOCell_ABR.VAR" +
                    ".r" + restart +
                    ".rR" + abrRate +
                    ".rL" + abrLength +
                    ".e" + i +
                    "." + run);
            frontsAtEpoch.get(i).printObjectivesToFile("DMOCell_ABR.FUN" +
                    ".r" + restart +
                    ".rR" + abrRate +
                    ".rL" + abrLength +
                    ".e" + i +
