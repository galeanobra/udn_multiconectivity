...
import jmetal.problems.UDN.model.users.MobilityModel;
import jmetal.problems.UDN.model.users.RandomWaypoint;
...
public class DynamicUDN extends UDN implements Serializable {
    ...
    private void loadDynamicUserConfig(List<User> users, List<String> configs, boolean demands) {
        ...
        for (String s : configs) {
            ...
            String DemandedService = pro.getProperty("UserDemandedService");
            String ServiceGroup = pro.getProperty("ServiceGroup"); //eMBB or URLLC
