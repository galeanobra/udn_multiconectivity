...
public abstract class UDN {
    ...
    static long seed_;
    int N_Signals_; //Number of signals for each user
    double SINR_Threshold_; // Threshold for applying MC (%)
    ...
    private void loadMainParameters(String configFile) {
        ...
        try {
            ...
            this.N_Signals_ = Integer.parseInt(pro.getProperty("N_Signals"));
            this.SINR_Threshold_= Integer.parseInt(pro.getProperty("SINR_Threshold"));
...
//            System.out.println(i + " " + j + " " + k);
    ...
    /**
     * Clear The array list of Serving Cells for each user of the UDN
     */
    public void resetUsersServingCellsAssigned() {
    ...
    /**
     * Returns the threshold below which multiconnectivity is not applied
     *
     * @return The Threshold
     */
    public double getMCThreshold() {
        if (this.SINR_Threshold_ > 100){
            return 1;
        }else {
            return this.SINR_Threshold_ / 100;
        }
    }

    public Cell getClosestCellByType(Point gridPoint, CellType newType){
    ...
    /**
     * Returns the Number of signals for each user in the UDN
     *
     * @return Integer of Number of signals for MC
     */
    public int getN_signals(){

        return this.N_Signals_;
