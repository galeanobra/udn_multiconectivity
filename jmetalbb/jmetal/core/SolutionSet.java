...
public class SolutionSet implements Serializable {
    ...
    public void printObjectivesToFile(String path) {
        try {
            ...
            for (int i = 0; i < solutionsList_.size(); i++) {
                ...
                if (solutionsList_.get(i).getNumberOfViolatedConstraint() == 0) {
    ...
    public void printAllObjectivesToFile(String path) {
        try {
            /* Open the file */
            FileOutputStream fos = new FileOutputStream(path);
            OutputStreamWriter osw = new OutputStreamWriter(fos);
     ...
     * @param path The output file name
     */
    public void printAllVariablesToFile(String path) {
        try {
            /* Open the file */
            FileOutputStream fos = new FileOutputStream(path);
            OutputStreamWriter osw = new OutputStreamWriter(fos);
    ...
    public void printFeasibleFUN(String path) {
        try {
            ...
            for (int i = 0; i < solutionsList_.size(); i++) {
                //if (this.vector[i].getFitness()<1.0) {
                if (solutionsList_.get(i).getOverallConstraintViolation() == 0.0) {
                    bw.write(solutionsList_.get(i).toString());
                    bw.newLine();
                }
                //}
