...
public class Solution implements Serializable {
     ...
     */
    protected double crowdingDistance_;
    /**
     * Stores the distance between this solution and a <code>SolutionSet</code>.
     * Used in AbySS.
     */
    protected double distanceToSolutionSet_;
    ...
    public Solution(Solution solution) {
        ...
        currentUesToCellAssignment_ = solution.currentUesToCellAssignment_;
        previousUesToCellAssignment_ = solution.previousUesToCellAssignment_;
    } // Solution
    ...
    public String toString1() {
        String aux = "[";
        for (int i = 0; i < this.numberOfObjectives_ - 1; i++) {
            aux = aux + this.getObjective(i) + ", ";
        }

        aux += this.getObjective(this.numberOfObjectives_ - 1)
                + "] C[" + this.getOverallConstraintViolation()
                + ", " + this.numberOfViolatedConstraints_ + "]";
    ...
    /**
     * Indicates if the solution is mark.
     *
     * @return true if the method <code>mark</code> has been called and, after
    ...
    /**
     * Establishes the solution as mark.
     */
    public void mark() {
        this.marked_ = true;
    } // mark
