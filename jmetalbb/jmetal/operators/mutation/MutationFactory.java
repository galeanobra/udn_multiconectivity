...
public class MutationFactory {
    ...
    public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException {
        ...
        else if (name.equalsIgnoreCase("SensorPolynomialMutation"))
            return new SensorPolynomialMutation(parameters);
        else if (name.equalsIgnoreCase("SensorRandomMutation"))
            return new SensorRandomMutation(parameters);
