...
public class CrossoverFactory {
    ...
    public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
        ...
        else if (name.equalsIgnoreCase("SensorSBXCrossover"))
            return new SensorSBXCrossover(parameters);
        else if (name.equalsIgnoreCase("SensorRectangularCrossover"))
            return new SensorRectangularCrossover(parameters);
        else {
